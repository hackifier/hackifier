 ...
 */
final class NewToken extends EditableTokenWithVariableText
{
    public function __construct(EditableNode $leading, EditableNode $trailing, string $token_text = 'new')
    {
