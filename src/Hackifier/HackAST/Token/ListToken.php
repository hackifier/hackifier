 ...
 */
final class ListToken extends EditableTokenWithVariableText
{
    public function __construct(EditableNode $leading, EditableNode $trailing, string $token_text = 'list')
    {
