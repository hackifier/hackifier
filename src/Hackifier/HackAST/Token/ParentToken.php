 ...
 */
final class ParentToken extends EditableTokenWithVariableText
{
    public function __construct(EditableNode $leading, EditableNode $trailing, string $token_text = 'parent')
    {
