...
use Hackifier\HackAST\EditableTokenWithFixedText;
 ...
 */
final class GreaterThanGreaterThanEqualToken extends EditableTokenWithFixedText
{
    ...
    protected static function text(): string
    {
        return '>>=';
    }
}