...
/**
 * @extends AbstractTransformer<Node\Scalar\MagicConst>
 */
class MagicConstantTransformer extends AbstractTransformer
{
    /**
    ...
    {
        return $this->comments($node, new NameToken(Missing(), Missing(), $node->getName()));
    }

    public function supports(Node $node): bool
    {
        return $node instanceof Node\Scalar\MagicConst;
    }
}
